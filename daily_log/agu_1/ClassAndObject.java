 ...
 * @date 2019/8/1
 */
public class ClassAndObject implements Comparator<ClassAndObject> {
    ...
    @Override
    public int compare(ClassAndObject o1, ClassAndObject o2) {
        return o1.age + o1.num > o2.age + o2.num ? 1 : (o1.age + o1.num == o2.age + o2.num ?0:-1);
    }
